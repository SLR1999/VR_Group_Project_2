...
PATH = 'weights/resnet18_yolo_new.pth'
...
class ResNet:
    def __init__(self):
        ...
        self.model.fc = nn.Sequential(nn.Linear(num_ftrs, 4), nn.Softmax(1))
        ...
        # opposed to before.
        self.trainer = optim.SGD(self.model.fc.parameters(), lr=0.001, momentum=0.9)
